...
{var overlay = temp__4092__auto____$1;var pos = lt.objs.editor.__GT_cursor.call(null,editor);var ln = new cljs.core.Keyword(null,"line","line",1017226086).cljs$core$IFn$_invoke$arity$1(pos);var line = lt.objs.editor.line.call(null,editor,ln);var map__7949 = cljs.core.js__GT_clj.call(null,overlay.suggest(line,new cljs.core.Keyword(null,"ch","ch",1013907415).cljs$core$IFn$_invoke$arity$1(pos)));var map__7949__$1 = ((cljs.core.seq_QMARK_.call(null,map__7949))?cljs.core.apply.call(null,cljs.core.hash_map,map__7949):map__7949);var start = cljs.core.get.call(null,map__7949__$1,"start");var size = cljs.core.get.call(null,map__7949__$1,"size");var suggestions = cljs.core.get.call(null,map__7949__$1,"suggestions");return cljs.core.map.call(null,((function (pos,ln,line,map__7949,map__7949__$1,start,size,suggestions,overlay,temp__4092__auto____$1,editor,temp__4092__auto__){
return (function (v){return new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"label","label",1116631654),v,new cljs.core.Keyword(null,"order","order",1119910592),0.3,new cljs.core.Keyword(null,"click","click",1108654330),((function (pos,ln,line,map__7949,map__7949__$1,start,size,suggestions,overlay,temp__4092__auto____$1,editor,temp__4092__auto__){
...
});})(pos,ln,line,map__7949,map__7949__$1,start,size,suggestions,overlay,temp__4092__auto____$1,editor,temp__4092__auto__))
], null);
});})(pos,ln,line,map__7949,map__7949__$1,start,size,suggestions,overlay,temp__4092__auto____$1,editor,temp__4092__auto__))
,suggestions);
} else
...
{return cljs.core.conj.call(null,cljs.core.concat.call(null,items,lt.plugins.spelling.getSuggestions.call(null)),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"type","type",1017479852),"separator",new cljs.core.Keyword(null,"order","order",1119910592),0.4], null));
} else
{return items;
}
});
...
lt.plugins.spelling.lang_input = (function (){var G__7950 = lt.objs.sidebar.command.filter_list.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"items","items",1114430258),(function (){return lt.plugins.spelling.manager.getLanguages();
}),new cljs.core.Keyword(null,"key","key",1014010321),cljs.core.identity,new cljs.core.Keyword(null,"placeholder","placeholder",1612151013),"Language"], null));lt.object.add_behavior_BANG_.call(null,G__7950,new cljs.core.Keyword("lt.plugins.spelling","exec-active!","lt.plugins.spelling/exec-active!",1621182710));
lt.object.add_behavior_BANG_.call(null,G__7950,new cljs.core.Keyword("lt.plugins.spelling","refresh-items!","lt.plugins.spelling/refresh-items!",1460892130));
return G__7950;
})();
...
lt.plugins.spelling.suggest_input = (function (){var G__7951 = lt.objs.sidebar.command.filter_list.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"items","items",1114430258),lt.plugins.spelling.getSuggestions,new cljs.core.Keyword(null,"key","key",1014010321),new cljs.core.Keyword(null,"label","label",1116631654),new cljs.core.Keyword(null,"placeholder","placeholder",1612151013),""], null));lt.object.add_behavior_BANG_.call(null,G__7951,new cljs.core.Keyword("lt.plugins.spelling","exec-active!","lt.plugins.spelling/exec-active!",1621182710));
lt.object.add_behavior_BANG_.call(null,G__7951,new cljs.core.Keyword("lt.plugins.spelling","refresh-items!","lt.plugins.spelling/refresh-items!",1460892130));
lt.object.add_behavior_BANG_.call(null,G__7951,new cljs.core.Keyword("lt.plugins.spelling","close-on-blur!","lt.plugins.spelling/close-on-blur!",3520433716));
return G__7951;
})();
