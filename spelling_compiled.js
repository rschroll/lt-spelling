...
{var overlay = temp__4092__auto____$1;var pos = lt.objs.editor.__GT_cursor.call(null,editor);var ln = new cljs.core.Keyword(null,"line","line",1017226086).cljs$core$IFn$_invoke$arity$1(pos);var line = lt.objs.editor.line.call(null,editor,ln);var token_type = lt.objs.editor.__GT_token_type.call(null,editor,pos);var markup_QMARK_ = lt.object.has_tag_QMARK_.call(null,editor,new cljs.core.Keyword(null,"editor.spelling.markup","editor.spelling.markup",1751484877));if(cljs.core.truth_((function (){var or__6371__auto__ = (cljs.core.not.call(null,markup_QMARK_)) && (cljs.core.contains_QMARK_.call(null,lt.plugins.spelling.check_tokens,token_type));if(or__6371__auto__)
{return or__6371__auto__;
} else
{var and__6359__auto__ = markup_QMARK_;if(cljs.core.truth_(and__6359__auto__))
...
lt.plugins.spelling.__BEH__enable = (function __BEH__enable(editor){return lt.plugins.spelling.addOverlay.call(null,editor,lt.plugins.spelling.default_lang.call(null));
});
...
{var editor = temp__4092__auto__;return lt.plugins.spelling.addOverlay.call(null,editor,lt.plugins.spelling.default_lang.call(null));
} else
{return null;
}
})], null));
